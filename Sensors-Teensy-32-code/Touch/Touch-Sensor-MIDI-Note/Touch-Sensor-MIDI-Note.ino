...
if (touchvalue > calib+tresHold){
  ...
  if (n0 != previousA0) {
    ...
    usbMIDI.sendNoteOn(constrain (map (n0, calib , maxVal, 0, 127), 0, 127), 99, channel); // 60 = C4
    delay(10);
    usbMIDI.sendNoteOff(constrain (map (n0, calib , maxVal, 0, 127), 0, 127), 0, channel); // 60 = C4
