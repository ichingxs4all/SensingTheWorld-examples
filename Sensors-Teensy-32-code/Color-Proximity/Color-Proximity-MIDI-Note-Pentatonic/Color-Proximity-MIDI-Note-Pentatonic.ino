...
void loop() {
 digitalWrite(LED_BUILTIN, HIGH);
  ...
  if (APDS.proximityAvailable()) {
    ...
    if(FilterPR.Current()<255){
    usbMIDI.sendNoteOn(mapPentatonic(FilterPR.Current()), 100, channel);
    delay(10);
    usbMIDI.sendNoteOff(mapPentatonic(FilterPR.Current()), 100, channel);
    }
  }
